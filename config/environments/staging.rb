...
Rails.application.configure do
  ...
  # Full error reports are disabled (set to true if you want detailed errors in staging).
  ...
  # Update this to match your staging domain
  config.action_mailer.default_url_options = { host: "staging.redtape.la" }
  ...
  config.hosts = [
    "staging.redtape.la",
    /.*\.staging\.redtape\.la/   # Allow requests from subdomains
  ]
